  ...
  return (
        ...
        <div>
          ...
          <div className='flex items-center gap-2 sm:gap-3'> 
            <button onClick={()=>navigate('/buy')} className='flex items-center gap-2 bg-blue-200 px-4 sm:px-6 py-1.5 sm:py-3 rounded-full hover:scale-110 transition-all duration-700'>
              <img className='w-5' src={assets.credit_star} alt="" />
              <p className='text-xm sm:text-sm font-medium text-gray-700'>Credit Left : {credit}</p>
            </button>
